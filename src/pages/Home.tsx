  ...
  return (
    <div className="animate-fade-in max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center py-16 relative overflow-hidden">
        ...
        <div className="absolute top-0 -left-24 w-96 h-96 bg-primary/5 rounded-full blur-3xl -z-10" />
        ...
        <div className="relative hidden lg:block">
          <div className="absolute -inset-4 bg-gradient-to-tr from-emerald-100 to-primary/20 rounded-full blur-3xl -z-10" />
